...
export const PRESENTATION_STEPS: PresentationStep[] = [
  ...
  },
  {
    id: "schedule",
    view: "schedule",
    title: "Schema som hela teamet litar på",
    description: "Skapa och dela schema i realtid. Alla ser sina pass direkt i mobilen – ingen mer \"jag visste inte att jag jobbade idag\". Systemet varnar automatiskt för vilotidsbrott och dubbelbokning.",
    example: "Exempel: Du lägger in Johans pass 06–14 på torsdag → systemet varnar: \"Johan har redan 48h denna vecka – max enligt kollektivavtalet är 50h.\" Ni undviker regelbrott innan de händer.",
    duration: 11000,
    icon: "📅",
  },
  {
    ...
    description: "Morgonrond, skyddsrond, egenkontroll – skapa mallar en gång och skicka till rätt personal automatiskt. Se i realtid vem som slutfört vad. Bevis på att rutinerna följs, utan att jaga folk.",
    example: "Exempel: \"Daglig skyddsrond – Etapp 3\" → ✅ Ställning kontrollerad · ✅ Fallskydd på plats · ✅ Brandpost tillgänglig – slutförd av Erik kl 06:42. Dokumenterat och spårbart.",
    duration: 11000,
    icon: "✅",
  },
  {
